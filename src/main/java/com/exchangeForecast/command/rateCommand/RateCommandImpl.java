...
public class RateCommandImpl implements RateCommand {
    ...
    @Builder
    public RateCommandImpl(Currency cdx, String period, LocalDate date, ForecastService algorithm, String outputMethod, SendBotMessageService sendBotMessageService, RatesCash cash) {
        this.cdx = cdx;
        this.period = period;
        this.date = date;
